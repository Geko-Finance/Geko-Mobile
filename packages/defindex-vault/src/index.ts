...
export const networks = {
  unknown: {
    ...
    contractId: "CCUZC3HC5TH2VCYZFUG57E6IGKPL45YUN2SI3UEYQUBA7RCYHUIZBSFV",
  }
} as const
...
export interface Client {
   ...
   * - `false`: Lea
   */
  deposit: ({amounts_desired, amounts_min, from, invest}: {amounts_desired: Array<i128>, amounts_min: Array<i128>, from: string, invest: boolean}, options?: MethodOptions) => Promise<AssembledTransaction<Result<readonly [Array<i128>, i128, Option<Array<Option<AssetInvestmentAllocation>>>]>>>
   ...
   * - `ContractError
   */
  withdraw: ({withdraw_shares, min_amounts_out, from}: {withdraw_shares: i128, min_amounts_out: Array<i128>, from: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<Array<i128>>>>
   ...
   */
  rescue: ({strategy_address, caller}: {strategy_address: string, caller: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  pause_strategy: ({strategy_address, caller}: {strategy_address: string, caller: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  unpause_strategy: ({strategy_address, caller}: {strategy_address: string, caller: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  get_assets: (options?: MethodOptions) => Promise<AssembledTransaction<Result<Array<AssetStrategySet>>>>
   ...
   */
  fetch_total_managed_funds: (options?: MethodOptions) => Promise<AssembledTransaction<Result<Array<CurrentAssetInvestmentAllocation>>>>
   ...
   */
  get_asset_amounts_per_shares: ({vault_shares}: {vault_shares: i128}, options?: MethodOptions) => Promise<AssembledTransaction<Result<Array<i128>>>>
   ...
   * 
   */
  get_fees: (options?: MethodOptions) => Promise<AssembledTransaction<readonly [u32, u32]>>
   ...
   */
  report: (options?: MethodOptions) => Promise<AssembledTransaction<Result<Array<Report>>>>
   ...
   * * `()` - No return value.
   */
  set_fee_receiver: ({caller, new_fee_receiver}: {caller: string, new_fee_receiver: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  get_fee_receiver: (options?: MethodOptions) => Promise<AssembledTransaction<Result<string>>>
   ...
   */
  set_manager: ({new_manager}: {new_manager: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  get_manager: (options?: MethodOptions) => Promise<AssembledTransaction<Result<string>>>
   ...
   * * `()` - No return value.
   */
  set_emergency_manager: ({emergency_manager}: {emergency_manager: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  get_emergency_manager: (options?: MethodOptions) => Promise<AssembledTransaction<Result<string>>>
   ...
   * * `()` - No return value.
   */
  set_rebalance_manager: ({new_rebalance_manager}: {new_rebalance_manager: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  get_rebalance_manager: (options?: MethodOptions) => Promise<AssembledTransaction<Result<string>>>
   ...
   * * `Result<(), ContractError>` - Ok if successful, otherwise returns a ContractError.
   */
  rebalance: ({caller, instructions}: {caller: string, instructions: Array<Instruction>}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  lock_fees: ({new_fee_bps}: {new_fee_bps: Option<u32>}, options?: MethodOptions) => Promise<AssembledTransaction<Result<Array<Report>>>>
   ...
   */
  release_fees: ({strategy, amount}: {strategy: string, amount: i128}, options?: MethodOptions) => Promise<AssembledTransaction<Result<Report>>>
   ...
   */
  distribute_fees: ({caller}: {caller: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<Array<readonly [string, i128]>>>>
   ...
   */
  get_reserves_with_factory: ({factory, token_a, token_b}: {factory: string, token_a: string, token_b: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<readonly [i128, i128]>>>
   ...
   * Returns `Result<(i128, i128), SoroswapLibraryError>` where `Ok` contains a tuple of sorted reserves, and `Err` indicates an error such as identical tokens or an issue with sorting.
   */
  get_reserves_with_pair: ({pair, token_a, token_b}: {pair: string, token_a: string, token_b: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<readonly [i128, i128]>>>
